...
(function($){
	var type_production,   production_item_full,
		...
		tooltip = works_portfolio.nextAll('#tooltip'),
		filters = works_portfolio.find('#type_products');
	...
	filters.find('.type_products_item').on('click', function(){
		...
		production_item_full = works_portfolio.find('.production_item_full');
	...
	//show detail product
	works_portfolio.on('click','.show_detail', function(){
	...
	works_portfolio.find('.close_description').on('click', function(event){
	...
	//add to basket
	works_portfolio.find('.add_basket').on('click', function(event){
